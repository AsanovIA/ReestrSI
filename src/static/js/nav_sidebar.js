'use strict';
{
    ...
    if (toggleNavSidebar !== null) {
        ...
        let navSidebarIsOpen = sessionStorage.getItem('SidebarIsOpen');
        ...
        toggleNavSidebar.addEventListener('click', function() {
            ...
            sessionStorage.setItem('SidebarIsOpen', navSidebarIsOpen);
    ...
    function initSidebarQuickFilter() {
        ...
        function checkValue(event) {
            ...
            sessionStorage.setItem('SidebarFilterValue', filterValue);
        }
...
//        const filter = document.getElementById('filter-filter');
        ...
        const storedValue = sessionStorage.getItem('SidebarFilterValue');
        if (storedValue) {
